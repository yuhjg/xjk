...
CREATE TABLE `xjk_company` (
  ...
  `banner_height` varchar(10) NOT NULL DEFAULT '600' COMMENT 'Banner高度(px)',
  `stat1_value` varchar(20) NOT NULL DEFAULT '14' COMMENT '统计1-数值',
  `stat1_suffix` varchar(10) NOT NULL DEFAULT '+' COMMENT '统计1-后缀',
  `stat1_label` varchar(50) NOT NULL DEFAULT '行业经验（年）' COMMENT '统计1-标签',
  `stat1_image` varchar(255) NOT NULL DEFAULT '' COMMENT '统计1-图片',
  `stat2_value` varchar(20) NOT NULL DEFAULT '200' COMMENT '统计2-数值',
  `stat2_suffix` varchar(10) NOT NULL DEFAULT '+' COMMENT '统计2-后缀',
  `stat2_label` varchar(50) NOT NULL DEFAULT '产品种类' COMMENT '统计2-标签',
  `stat2_image` varchar(255) NOT NULL DEFAULT '' COMMENT '统计2-图片',
  `stat3_value` varchar(20) NOT NULL DEFAULT '500' COMMENT '统计3-数值',
  `stat3_suffix` varchar(10) NOT NULL DEFAULT '+' COMMENT '统计3-后缀',
  `stat3_label` varchar(50) NOT NULL DEFAULT '服务客户' COMMENT '统计3-标签',
  `stat3_image` varchar(255) NOT NULL DEFAULT '' COMMENT '统计3-图片',
  `stat4_value` varchar(20) NOT NULL DEFAULT '8' COMMENT '统计4-数值',
